...
@Component({
  selector: 'app-codeappsmenu-settings',
  templateUrl: './codeappsmenu-settings.component.html',
  styleUrls: ['./codeappsmenu-settings.component.scss']
})
export class CodeappsmenuSettingsComponent implements OnInit {
  ddlUser = 1;
  MenuList: any;
  ...
  fnMenuGets() {
    ...
    var ServiceParams = {};
    ServiceParams['strProc'] = 'Menu_GetsOnAccessLevelId';
    var oProcParams = [];
